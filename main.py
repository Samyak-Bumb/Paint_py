...
class Paint(object):
    ...
    def __init__(self):
        ...
        self.pen_logo = ImageTk.PhotoImage(Image.open('img/pen.png'))
        ...
        self.brush_logo = ImageTk.PhotoImage(Image.open('img/brush.png'))
        ...
        self.color_logo = ImageTk.PhotoImage(Image.open('img/color.png'))
        ...
        self.eraser_logo = ImageTk.PhotoImage(Image.open('img/eraser.png'))
